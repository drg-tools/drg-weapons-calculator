	...
	public static double lambertInverseWNumericalApproximation(double z) {
		...
		if (z > -0.006922) {
			/*
				...
				Re((-7.44753 - 266.09 (z + 0.004341) - 29911.2 (z + 0.004341)^2 - 4.55864x10^6 (z + 0.004341)^3 - 7.84078x10^8 (z + 0.004341)^4 - 1.4405x10^11 (z + 0.004341)^5
			*/
			zed = z + 0.004341;
			A = -7.44753;
			B = -266.09 * zed;
			...
			/*
				...
				Re((-6.53302 - 124.248 (z + 0.009503) - 6323.79 (z + 0.009503)^2 - 439586. (z + 0.009503)^3 - 3.45057x10^7 (z + 0.009503)^4 - 2.89403x10^9 (z + 0.009503)^5
			*/
			zed = z + 0.009503;
			A = -6.53302;
			B = -124.248 * zed;
			...
			/*
				...
				Re((-6.01686 - 81.7817 (z + 0.014665) - 2677.54 (z + 0.014665)^2 - 120506. (z + 0.014665)^3 - 6.12574x10^6 (z + 0.014665)^4 - 3.32788x10^8 (z + 0.014665)^5
			*/
			zed = z + 0.014665;
			A = -6.01686;
			B = -81.7817 * zed;
			...
			/*
				...
				Re((-5.65287 - 61.2761 (z + 0.019827) - 1473.89 (z + 0.019827)^2 - 49040.5 (z + 0.019827)^3 - 1.84292x10^6 (z + 0.019827)^4 - 7.40287x10^7 (z + 0.019827)^5
			*/
			zed = z + 0.019827;
			A = -5.65287;
			B = -61.2761 * zed;
			...
			/*
				...
				Re((-5.37018 - 49.1746 (z + 0.024989) - 932.406 (z + 0.024989)^2 - 24610.3 (z + 0.024989)^3 - 733474. (z + 0.024989)^4 - 2.33705x10^7 (z + 0.024989)^5
			*/
			zed = z + 0.024989;
			A = -5.37018;
			B = -49.1746 * zed;
			...
			/*
				...
				Re((-5.13825 - 41.181 (z + 0.030151) - 643.035 (z + 0.030151)^2 - 14067.5 (z + 0.030151)^3 - 347338. (z + 0.030151)^4 - 9.17029x10^6 (z + 0.030151)^5
			*/
			zed = z + 0.030151;
			A = -5.13825;
			B = -41.181 * zed;
			...
			/*
				...
				Re((-4.94109 - 35.5036 (z + 0.035313) - 470.333 (z + 0.035313)^2 - 8787.86 (z + 0.035313)^3 - 185186. (z + 0.035313)^4 - 4.17369x10^6 (z + 0.035313)^5
			*/
			zed = z + 0.035313;
			A = -4.94109;
			B = -35.5036 * zed;
			...
			/*
				...
				Re((-4.76926 - 31.2614 (z + 0.040475) - 358.999 (z + 0.040475)^2 - 5855.3 (z + 0.040475)^3 - 107607. (z + 0.040475)^4 - 2.11556x10^6 (z + 0.040475)^5
			*/
			zed = z + 0.040475;
			A = -4.76926;
			B = -31.2614 * zed;
			...
			/*
				...
				Re((-4.61672 - 27.9706 (z + 0.045637) - 283.019 (z + 0.045637)^2 - 4097.1 (z + 0.045637)^3 - 66748.8 (z + 0.045637)^4 - 1.16369x10^6 (z + 0.045637)^5
			*/
			zed = z + 0.045637;
			A = -4.61672;
			B = -27.9706 * zed;
