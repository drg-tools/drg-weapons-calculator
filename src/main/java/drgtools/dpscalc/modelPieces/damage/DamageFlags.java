...
public class DamageFlags {
    // Technically speaking, lightArmor and heavyArmor are the same Material Flag.
    ...
    // Because all three of those do nothing if they don't damage the enemy's healthbar, which works through Light Armor but not Heavy or Unbreakable Armor.
