...
public abstract class Classic extends Weapon {
	...
	****************************************************************************************/
	...
	protected void initializeModsAndOverclocks() {
		...
		tier5[1] = new Mod("Precision Terror", "Killing an enemy with a focused shot to a weakpoint will inflict 2.0 Fear on enemies within 3.5m of the kill", modIcons.fear, 5, 1);
		...
		overclocks[5] = new Overclock(Overclock.classification.unstable, "Supercooling Chamber", "+80% Focused Shot Multiplier, x0.75 Max Ammo, -2.5 Rate of Fire, no movement while focusing", overclockIcons.directDamage, 5);
	}
