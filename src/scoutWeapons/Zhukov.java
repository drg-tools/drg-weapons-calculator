...
public class Zhukov extends Weapon {
	...
	****************************************************************************************/
	...
	public ArrayList<String> exportModsToMySQL() {
		...
		// Tier 2
		toReturn.add(String.format(rowFormat, 2, tier2[0].getLetterRepresentation(), tier2[0].getName(), 1800, 18, 0, 0, 0, 12, 0, tier2[0].getText(true), ""));
		...
		toReturn.add(String.format(rowFormat, 2, tier2[2].getLetterRepresentation(), tier2[2].getName(), 1800, 0, 18, 0, 0, 12, 0, tier2[2].getText(true), ""));
		...
		// Tier 4
		toReturn.add(String.format(rowFormat, 4, tier4[0].getLetterRepresentation(), tier4[0].getName(), 3800, 0, 25, 0, 0, 15, 0, tier4[0].getText(true), ""));
		...
		toReturn.add(String.format(rowFormat, 4, tier4[2].getLetterRepresentation(), tier4[2].getName(), 3800, 25, 36, 0, 0, 0, 15, tier4[2].getText(true), ""));
		
		// Tier 5
		toReturn.add(String.format(rowFormat, 5, tier5[0].getLetterRepresentation(), tier5[0].getName(), 4400, 0, 0, 60, 40, 0, 110, tier5[0].getText(true), ""));
		toReturn.add(String.format(rowFormat, 5, tier5[1].getLetterRepresentation(), tier5[1].getName(), 4400, 40, 60, 0, 0, 110, 0, tier5[1].getText(true), ""));
	...
	public ArrayList<String> exportOCsToMySQL() {
		...
		// Credits, Magnite, Bismor, Umanite, Croppa, Enor Pearl, Jadiz
		// Clean
		toReturn.add(String.format(rowFormat, "Clean", overclocks[0].getShortcutRepresentation(), overclocks[0].getName(), 8450, 0, 130, 0, 100, 0, 70, overclocks[0].getText(true), ""));
		
		// Balanced
		toReturn.add(String.format(rowFormat, "Balanced", overclocks[1].getShortcutRepresentation(), overclocks[1].getName(), 7700, 0, 95, 0, 75, 140, 0, overclocks[1].getText(true), ""));
		
		// Unstable
		toReturn.add(String.format(rowFormat, "Unstable", overclocks[2].getShortcutRepresentation(), overclocks[2].getName(), 7300, 135, 0, 95, 65, 0, 0, overclocks[2].getText(true), ""));
		toReturn.add(String.format(rowFormat, "Unstable", overclocks[3].getShortcutRepresentation(), overclocks[3].getName(), 7550, 65, 0, 90, 0, 0, 135, overclocks[3].getText(true), ""));
		toReturn.add(String.format(rowFormat, "Unstable", overclocks[4].getShortcutRepresentation(), overclocks[4].getName(), 7800, 125, 0, 0, 0, 70, 105, overclocks[4].getText(true), ""));
