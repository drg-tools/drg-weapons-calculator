...
public class Zhukov extends Weapon {
	...
	****************************************************************************************/
	...
	protected void initializeModsAndOverclocks() {
		...
		overclocks[2] = new Overclock(Overclock.classification.unstable, "Cryo Minelets", "Any bullets that impact terrain get converted to Cryo Minelets. After 1 second of arming time they will explode on any "
				+ "enemies that get close, dealing 5 Cold Damage each. They automatically explode after 3 seconds. -1 Direct Damage, -10 Magazine Size", overclockIcons.coldDamage, 2);
	...
	****************************************************************************************/
	...
	private double calculateAvgNumBulletsNeededToFreeze() {
		...
		double timeToFreeze = EnemyInformation.averageTimeToFreeze(-5, effectiveRoF);
	...
	public double utilityScore() {
		...
		if (selectedOverclock == 2) {
			...
			// Minelets seem to do 5 Cold Damage each, and they don't explode in a radius -- instead it seems that they spurt off in a random direction for 2.5m.
