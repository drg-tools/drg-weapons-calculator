...
public class SMG extends Weapon {
	...
	****************************************************************************************/
	...
	protected void initializeModsAndOverclocks() {
		...
		overclocks[0] = new Overclock(Overclock.classification.clean, "Turret Arc", "If a bullet fired from the SMG hits a turret and applies an Electrocute DoT, that turret deals constant Electric Damage in a small radius around it for 15 seconds. Additionally, "
				+ "if 2 turrets are less than 10m apart and both are electrocuted at the same time, then an electric arc will pass between them for 10 seconds that slows enemies by 70% and does 20 Electric Damage per Second until the first turret's electrocute expires.", overclockIcons.electricity, 0, false);
