...
public class Shotgun extends Weapon {
	...
	****************************************************************************************/
	...
	public ArrayList<String> exportModsToMySQL() {
		...
		toReturn.add(String.format(rowFormat, 2, tier2[2].getLetterRepresentation(), tier2[2].getName(), 2000, 24, 0, 15, 0, 0, 0, tier2[2].getText(), ""));
		...
		toReturn.add(String.format(rowFormat, 3, tier3[1].getLetterRepresentation(), tier3[1].getName(), 2800, 35, 0, 0, 0, 50, 0, tier3[1].getText(), ""));
		toReturn.add(String.format(rowFormat, 3, tier3[2].getLetterRepresentation(), tier3[2].getName(), 2800, 0, 50, 0, 0, 35, 0, tier3[2].getText(), ""));
		...
		// Tier 5
		toReturn.add(String.format(rowFormat, 5, tier5[0].getLetterRepresentation(), tier5[0].getName(), 5600, 0, 0, 0, 64, 70, 140, tier5[0].getText(), ""));
		toReturn.add(String.format(rowFormat, 5, tier5[1].getLetterRepresentation(), tier5[1].getName(), 5600, 64, 70, 0, 140, 0, 0, tier5[1].getText(), ""));
	...
	public ArrayList<String> exportOCsToMySQL() {
		...
		// Credits, Magnite, Bismor, Umanite, Croppa, Enor Pearl, Jadiz
		// Clean
		toReturn.add(String.format(rowFormat, "Clean", overclocks[0].getShortcutRepresentation(), overclocks[0].getName(), 7350, 60, 100, 0, 0, 0, 135, overclocks[0].getText(), ""));
		toReturn.add(String.format(rowFormat, "Clean", overclocks[1].getShortcutRepresentation(), overclocks[1].getName(), 7250, 105, 0, 60, 125, 0, 0, overclocks[1].getText(), ""));
		
		// Balanced
		toReturn.add(String.format(rowFormat, "Balanced", overclocks[2].getShortcutRepresentation(), overclocks[2].getName(), 7900, 0, 0, 75, 0, 120, 105, overclocks[2].getText(), ""));
		
		// Unstable
		toReturn.add(String.format(rowFormat, "Unstable", overclocks[3].getShortcutRepresentation(), overclocks[3].getName(), 8050, 0, 125, 80, 100, 0, 0, overclocks[3].getText(), ""));
		toReturn.add(String.format(rowFormat, "Unstable", overclocks[4].getShortcutRepresentation(), overclocks[4].getName(), 7700, 90, 0, 0, 125, 65, 0, overclocks[4].getText(), ""));
