...
public class Subata extends Weapon {
	...
	****************************************************************************************/
	...
	public int breakpoints() {
		...
		breakpoints = EnemyInformation.calculateBreakpoints(directDamage, areaDamage, DoTDamage, getWeakpointBonus(), macteraBonus, 0.0, statusEffects[1], statusEffects[3]);
	...
	public double damageWastedByArmor() {
		return EnemyInformation.percentageDamageWastedByArmor(getDirectDamage(), getAreaDamage(), armorBreaking, getWeakpointBonus(), estimatedAccuracy(false), estimatedAccuracy(true), true);
	}
