...
public class EPC_RegularShot extends EPC {
	...
	****************************************************************************************/
	...
	public StatsRow[] getStats() {
		...
		toReturn[1] = new StatsRow("Projectile Velocity:", convertDoubleToPercentage(getRegularShotVelocity()), modIcons.projectileVelocity, selectedTier4 == 1, selectedTier4 == 1);
	...
	****************************************************************************************/
	...
	public int breakpoints() {
		...
		breakpoints = EnemyInformation.calculateBreakpoints(directDamage, areaDamage, DoTDamage, getRegularShotWeakpointBonus(), 0.0, 0.0, statusEffects[1], statusEffects[3], false);
	...
	public double damageWastedByArmor() {
		...
		damageWastedByArmorPerCreature = EnemyInformation.percentageDamageWastedByArmor(getDirectDamage(), 0.0, 1.0, getRegularShotWeakpointBonus(), 100.0, weakpointAccuracy);
