...
public class CryoCannon extends Weapon {
	...
	****************************************************************************************/
	...
	public ArrayList<String> exportOCsToMySQL() {
		...
		toReturn.add(String.format(rowFormat, "Balanced", overclocks[3].getShortcutRepresentation(), overclocks[3].getName(), 8950, 0, 0, 110, 0, 60, 130, overclocks[3].getText(true), "{ \"reload\": { \"name\": \"Repressurization Delay\", \"value\": 1 }, "
				+ "\"ex8\": { \"name\": \"Ice Spear\", \"value\": 1, \"boolean\": true } }", "Icon_Upgrade_ProjectileSpeed"));
		
		// Unstable
		toReturn.add(String.format(rowFormat, "Unstable", overclocks[4].getShortcutRepresentation(), overclocks[4].getName(), 7200, 105, 0, 75, 0, 130, 0, overclocks[4].getText(true), "{ \"dmg\": { \"name\": \"Damage\", \"value\": 2, \"multiply\": true }, "
		...
		toReturn.add(String.format(rowFormat, "Unstable", overclocks[5].getShortcutRepresentation(), overclocks[5].getName(), 8400, 0, 0, 130, 70, 0, 90, overclocks[5].getText(true), "{ \"clip\": { \"name\": \"Tank Capacity\", \"value\": 100, \"subtract\": true }, "
