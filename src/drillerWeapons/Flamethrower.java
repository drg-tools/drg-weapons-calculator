...
public class Flamethrower extends Weapon {
	...
	****************************************************************************************/
	...
	protected void initializeModsAndOverclocks() {
		...
		tier5 = new Mod[2];
		tier5[0] = new Mod("Heat Radiance", "After every full second of firing, deal 45 Fire element Area Damage and 60 Heat in a 3m radius around you. The Heat/sec stacks with the direct stream and Sticky Flames' heat sources as well.", modIcons.heatDamage, 5, 0);
