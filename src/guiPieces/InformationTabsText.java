...
public class InformationTabsText {
	...
	public static JPanel getGlossaryText() {
		...
		String[][] glossaryText = {
			...
			{"Persistent Plasma (DoT)", "Similar to Radiation, this is an area-of-effect DoT that gets left behind by certain mods and overclocks. It deals an average of " + MathUtils.round(DoTInformation.Plasma_Trail_DPS, GuiConstants.numDecimalPlaces) + " Electric Damage per second."},
