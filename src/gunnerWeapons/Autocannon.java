...
public class Autocannon extends Weapon {
	...
	****************************************************************************************/
	...
	public ArrayList<String> exportModsToMySQL() {
		...
		// Tier 1
		toReturn.add(String.format(rowFormat, 1, tier1[0].getLetterRepresentation(), tier1[0].getName(), 1200, 0, 25, 0, 0, 0, 0, tier1[0].getText(true), "{ \"dmg\": { \"name\": \"Damage\", \"value\": 3 } }", "Icon_Upgrade_DamageGeneral"));
		toReturn.add(String.format(rowFormat, 1, tier1[1].getLetterRepresentation(), tier1[1].getName(), 1200, 0, 0, 0, 0, 25, 0, tier1[1].getText(true), "{ \"clip\": { \"name\": \"Magazine Size\", \"value\": 110 } }", "Icon_Upgrade_ClipSize"));
		toReturn.add(String.format(rowFormat, 1, tier1[2].getLetterRepresentation(), tier1[2].getName(), 1200, 0, 0, 0, 25, 0, 0, tier1[2].getText(true), "{ \"ammo\": { \"name\": \"Max Ammo\", \"value\": 220 } }", "Icon_Upgrade_Ammo"));
		
		// Tier 2
		toReturn.add(String.format(rowFormat, 2, tier2[0].getLetterRepresentation(), tier2[0].getName(), 2000, 0, 0, 0, 24, 15, 0, tier2[0].getText(true), "{ \"ex3\": { \"name\": \"Base Spread\", \"value\": 30, \"percent\": true, \"subtract\": true } }", "Icon_Upgrade_Accuracy"));
		toReturn.add(String.format(rowFormat, 2, tier2[1].getLetterRepresentation(), tier2[1].getName(), 2000, 0, 0, 0, 0, 15, 24, tier2[1].getText(true), "{ \"rate\": { \"name\": \"Top Rate of Fire\", \"value\": 1.5 } }", "Icon_Upgrade_FireRate"));
		toReturn.add(String.format(rowFormat, 2, tier2[2].getLetterRepresentation(), tier2[2].getName(), 2000, 0, 15, 0, 0, 24, 0, tier2[2].getText(true), "{ \"ex4\": { \"name\": \"Rate of Fire Growth Speed\", \"value\": 100, \"percent\": true } }", "Icon_Upgrade_FireRate"));
		
		// Tier 3
		toReturn.add(String.format(rowFormat, 3, tier3[0].getLetterRepresentation(), tier3[0].getName(), 2800, 0, 0, 0, 50, 0, 35, tier3[0].getText(true), "{ \"rate\": { \"name\": \"Top Rate of Fire\", \"value\": 2 } }", "Icon_Upgrade_FireRate"));
		toReturn.add(String.format(rowFormat, 3, tier3[1].getLetterRepresentation(), tier3[1].getName(), 2800, 35, 0, 50, 0, 0, 0, tier3[1].getText(true), "{ \"ex1\": { \"name\": \"Area Damage\", \"value\": 2 } }", "Icon_Upgrade_AreaDamage"));
		toReturn.add(String.format(rowFormat, 3, tier3[2].getLetterRepresentation(), tier3[2].getName(), 2800, 50, 0, 0, 0, 35, 0, tier3[2].getText(true), "{ \"dmg\": { \"name\": \"Damage\", \"value\": 4 } }", "Icon_Upgrade_DamageGeneral"));
		
		// Tier 4
		toReturn.add(String.format(rowFormat, 4, tier4[0].getLetterRepresentation(), tier4[0].getName(), 4800, 48, 0, 0, 0, 50, 72, tier4[0].getText(true), "{ \"ex5\": { \"name\": \"Armor Breaking\", \"value\": 400, \"percent\": true } }", "Icon_Upgrade_ArmorBreaking"));
		toReturn.add(String.format(rowFormat, 4, tier4[1].getLetterRepresentation(), tier4[1].getName(), 4800, 50, 0, 48, 0, 0, 72, tier4[1].getText(true), "{ \"ex2\": { \"name\": \"Effect Radius\", \"value\": 0.6 } }", "Icon_Upgrade_Area"));
		
		// Tier 5
		toReturn.add(String.format(rowFormat, 5, tier5[0].getLetterRepresentation(), tier5[0].getName(), 5600, 64, 70, 0, 140, 0, 0, tier5[0].getText(true), "{ \"ex7\": { \"name\": \"Top RoF Damage Bonus\", \"value\": 20, \"percent\": true } }", "Icon_Upgrade_DamageGeneral"));
		toReturn.add(String.format(rowFormat, 5, tier5[1].getLetterRepresentation(), tier5[1].getName(), 5600, 64, 70, 140, 0, 0, 0, tier5[1].getText(true), "{ \"ex8\": { \"name\": \"Impact Fear AoE\", \"value\": 1 } }", "Icon_Upgrade_ScareEnemies"));
		toReturn.add(String.format(rowFormat, 5, tier5[2].getLetterRepresentation(), tier5[2].getName(), 5600, 0, 0, 0, 64, 70, 140, tier5[2].getText(true), "{ \"ex9\": { \"name\": \"Damage Resistance at Full RoF\", \"value\": 33, \"percent\": true } }", "Icon_Upgrade_Resistance"));
