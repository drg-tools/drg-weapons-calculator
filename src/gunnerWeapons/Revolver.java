...
public abstract class Revolver extends Weapon {
	...
	****************************************************************************************/
	...
	public StatsRow[] getStats() {
		...
		toReturn[16] = new StatsRow("Spread Variance:", convertDoubleToPercentage(getSpreadVariance()), modIcons.baseSpread, selectedOverclock == 4, selectedOverclock == 4);
	...
	****************************************************************************************/
	...
	public double damageWastedByArmor() {
		damageWastedByArmorPerCreature = EnemyInformation.percentageDamageWastedByArmor(getDirectDamage(), getAreaDamage(), getArmorBreaking(), getWeakpointBonus(), estimatedAccuracy(false), estimatedAccuracy(true));
